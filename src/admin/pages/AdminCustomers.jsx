                ...
                {selected && (
                    <div className="space-y-4" dir="rtl">
                        ...
                        <div className="rounded-2xl p-4 text-right"
                            ...
                            <p className="text-[#86868B] text-[10px] font-black uppercase tracking-widest mb-1">נושא</p>
                        ...
                        {selected.message && (
                            <div className="rounded-2xl p-4 text-right"
                                ...
                                <p className="text-[#AEAEB2] text-[10px] font-black uppercase tracking-widest mb-2">הודעה</p>
                                <p className="text-[#1D1D1F] text-sm leading-relaxed whitespace-pre-line">{selected.message}</p>
                            </div>
                        )}

                        <div className="flex flex-wrap gap-2 justify-end items-center">
                            <p className="text-[#86868B] text-[10px] font-black uppercase tracking-widest">עדכן סטטוס:</p>
                        ...
                        {(() => {
                            ...
                            return (
                                <div className="rounded-2xl p-4 space-y-2 max-h-40 overflow-y-auto custom-scrollbar"
                                    style={{ background: 'rgba(0,0,0,0.03)', border: '1px solid rgba(0,0,0,0.06)' }}>
                                    <p className="text-[#AEAEB2] text-[10px] font-black uppercase tracking-widest mb-2 text-right">היסטוריית הערות</p>
                                    {notes.map((n, i) => (
