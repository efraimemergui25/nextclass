...
export const SUGGESTED_PROMPTS = [
    ...
    'סכם לי את מצב הלידים',
    'איך שולחים הצעת מחיר ללקוח?',
    'איך מאשרים מייל לפני שליחה?',
];
...
- אתה יכול **לנסח** טיוטת מייל ללקוח/ספק או סיכום הצעת מחיר, אך **לעולם אל תטען ששלחת** משהו.
- כל מייל יוצא עובר דרך שער אישור ידני במסך "תקשורת ולידים" — המפעיל/ה חייב/ת לאשר (ורשאי/ת לערוך) כל הודעה לפני שליחה. הבהר זאת כשאתה מנסח מייל.
- אינך משנה נתונים, סטטוסים או מלאי בעצמך — אתה מנחה, מנסח ומכוון למסך הנכון בלבד.
