...
const ProductDetail = () => {
 ...
 <ol className="flex items-center space-x-2 space-x-reverse text-gray-500 font-bold">
 ...
 <span className="text-emerald-700 text-xs md:text-sm font-extrabold">מאושר משרד החינוך</span>
 </span>
 ...
 <h3 className="text-xs md:text-sm font-black text-[#1D1D1F] mb-6 md:mb-10">מפרט טכני תמציתי</h3>
 <div className="grid grid-cols-2 gap-y-6 md:gap-y-10 gap-x-6 md:gap-x-12">
 {Object.entries(product.specs).map(([key, value]) => (
 <div key={key}>
 <p className="text-xs md:text-sm font-bold text-gray-400 mb-1 md:mb-2">{key}</p>
 ...
 <span className="text-xs font-bold text-gray-400 mb-1 block">מחיר מוסדי בלעדי</span>
