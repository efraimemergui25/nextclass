...
const CartPage = () => {
 ...
 <p className="text-sm font-bold text-[#AEAEB2] mb-8">{content.skuLabel}{item.sku}</p>
 ...
 <span className="text-sm font-bold text-[#AEAEB2] mt-2 block ">{content.taxNote}</span>
 </div>
 </div>
 </div>
