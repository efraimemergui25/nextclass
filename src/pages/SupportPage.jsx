...
const AcademyCard = ({ title, duration, category, image, level }) => (
 ...
 <span className="text-[9px] font-black text-[#007AFF]">{category}</span>
...
const PathCard = ({ title, count, icon: Icon, color }) => (
 ...
 <p className="text-[10px] font-black text-gray-400">{count} מדריכים זמינים</p>
 </div>
...
const SupportPage = () => {
 ...
 <h3 className="text-lg font-black text-gray-400 text-right px-4 mb-4">מסלולי למידה</h3>
 ...
 <h4 className="text-[9px] font-black text-gray-400 text-right mb-8">משאבים נוספים</h4>
