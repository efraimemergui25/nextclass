...
export default function CheckoutPage() {
 ...
 <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white rounded-full text-[11px] font-black text-[#007AFF] mb-4 shadow-sm">
 ...
 <div>
 <label className="text-[12px] font-black text-[#1D1D1F] block mb-2">תפקיד <span className="text-[#FF375F]">*</span></label>
 ...
 <div>
 <label className="text-[12px] font-black text-[#1D1D1F] block mb-2">סוג מוסד <span className="text-[#FF375F]">*</span></label>
 <div className="flex flex-wrap gap-2">
 ...
 <div>
 <label className="text-[12px] font-black text-[#1D1D1F] block mb-3">אמצעי קשר מועדף</label>
 ...
 <div>
 <label className="text-[12px] font-black text-[#1D1D1F] block mb-3">שעת יצירת קשר מועדפת</label>
 ...
 <div className="space-y-5">
 <div>
 <label className="text-[12px] font-black text-[#1D1D1F] block mb-3">טווח תקציב משוער</label>
 <div className="flex flex-wrap gap-2">
 {BUDGET_RANGES.map(b => (
 ...
 <div>
 <label className="text-[12px] font-black text-[#1D1D1F] block mb-3">דחיפות הרכישה</label>
 <div className="flex gap-3">
 {URGENCY_OPTS.map(u => (
 ...
 <label className="text-[12px] font-black text-[#1D1D1F]">הערות / דרישות מיוחדות</label>
 <textarea
 value={form.notes}
