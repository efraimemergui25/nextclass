...
function Accordion({ title, accent = '#5856D6', defaultOpen = false, children }) {
...
export default function MobileTerms() {
    ...
    return (
        <div style={{ fontFamily: SF, direction: 'rtl', padding: '16px 16px 32px' }}>
            ...
            {/* ── Sections ─────────────────────────────────────────── */}
            <Accordion title="כללי" accent="#5856D6" defaultOpen>
                <RichText text={`ברוכים הבאים ל-NextClass. השימוש באתר getnextclass.com ובשירותים הניתנים על ידינו כפוף לתנאי השימוש המפורטים להלן.\n\nהגלישה באתר ומילוי טפסים מהווים הסכמה מלאה לתנאים אלו.`} />
            </Accordion>

            <Accordion title="השירות ותהליך הרכישה" accent="#5856D6">
                <RichText text={`האתר מאפשר לגורמי חינוך להגיש בקשות להצעות מחיר עבור ציוד טכנולוגי.\n\n**חשוב לדעת:**\n• הגשת הצעת מחיר אינה יוצרת חוזה מחייב\n• המחירים המוצגים הם אינדיקטיביים ועשויים להשתנות\n• הצעת מחיר סופית תישלח בנפרד לאחר בדיקת הזמינות\n\n**זכאות לשירות:**\nהשירות מיועד לגופים מוסדיים בלבד (בתי ספר, מוסדות חינוך, עמותות).`} />
            </Accordion>

            <Accordion title="קניין רוחני" accent="#5856D6">
                <RichText text={`כל התוכן באתר — כולל טקסטים, תמונות, לוגו, עיצוב וקוד — הם רכושה הבלעדי של NextClass ומוגנים על פי דיני זכויות יוצרים.\n\n**מותר:** צפייה ושימוש אישי לצורך רכישה, שיתוף קישורים.\n\n**אסור:** העתקה, שכפול, הפצה, שימוש מסחרי ללא אישור בכתב.`} />
            </Accordion>

            <Accordion title="הגבלת אחריות" accent="#5856D6">
                <RichText text={`האתר ניתן "כמות שהוא". NextClass אינה מתחייבת לזמינות רציפה ורשאית לשנות כל חלק ממנו ללא הודעה מוקדמת.\n\nאחריות NextClass מוגבלת לסכום ששולם בפועל עבור השירות. NextClass לא תישא באחריות לנזקים עקיפים או תוצאתיים.`} />
            </Accordion>

            <Accordion title="כללי התנהגות" accent="#5856D6">
                <RichText text={`**שימוש מותר:**\nהגשת בקשות לגיטימיות להצעות מחיר לצורכי חינוך.\n\n**שימוש אסור:**\n• הגשת בקשות מזויפות או מידע כוזב\n• ניסיון לגשת לאזורים מוגבלים\n• שליחת בקשות אוטומטיות (bots)\n• כל פעולה שעלולה לפגוע בתשתית האתר`} />
            </Accordion>

            <Accordion title="פרטיות ומידע אישי" accent="#5856D6">
                <RichText text={`איסוף ועיבוד מידע אישי כפופים למדיניות הפרטיות שלנו, המהווה חלק בלתי נפרד מתנאי שימוש אלה.`} />
            ...
            <Accordion title="דין חל וסמכות שיפוט" accent="#5856D6">
                <RichText text={`תנאים אלה כפופים לדיני מדינת ישראל. כל מחלוקת תובא לדיון בבתי המשפט המוסמכים בתל אביב-יפו כסמכות שיפוט ייחודית.\n\nלפני פנייה לערכאות, הצדדים מחויבים לנסות להסכים בדרכי שלום תוך 30 יום.`} />
            </Accordion>

            <Accordion title="יצירת קשר" accent="#5856D6">
                <RichText text={`לשאלות, הבהרות או פניות משפטיות:\n\nNextClass\nדוא"ל: ${email}\nטלפון: ${phone}\nזמן מענה: עד 5 ימי עסקים`} />
            </Accordion>
