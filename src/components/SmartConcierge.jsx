...
${catalogInfo}`;
 ...
 <p className="text-[9px] text-[#007AFF] font-black mt-0.5 opacity-70">{getSetting('ai_role', 'Institutional Concierge')}</p>
 </div>
 ...
 <div>
 <p className="text-[10px] font-black text-[#86868B] mb-3 flex items-center gap-1.5">
 <Type size={12} />
 ...
 <span className="text-[8px] font-bold text-white/50 mt-1">Chat Support</span>
 </motion.div>
 )}
 </motion.div>
 )}
