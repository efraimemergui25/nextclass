...
const FloatingConcierge = () => {
    ...
    const whatsappUrl = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('שלום, אני מעוניין בהתייעצות לגבי מוצרי NextClass')}`;
        ...
        <div ref={ref} className="fixed bottom-6 right-6 z-[250] flex flex-col items-end gap-3">
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        {/* Header label */}
                        <p className="text-[11px] font-bold text-[#86868B] uppercase tracking-widest px-3 pt-1.5 pb-0.5">
                            דברו איתנו
                        </p>
                        ...
                        >
                            ...
                            <div className="text-right flex-1">
                                <span className="block text-sm font-bold text-[#1D1D1F] leading-tight">שיחה עם מומחה</span>
                                <span className="block text-[11px] text-[#86868B]">זמין א׳–ה׳, 9:00–18:00</span>
                            </div>
                        </a>
                        ...
                        >
                            ...
                            <div className="text-right flex-1">
                                <span className="block text-sm font-bold text-[#1D1D1F] leading-tight">וואטסאפ</span>
                                <span className="block text-[11px] text-[#86868B]">מענה מהיר עד שעה</span>
                            </div>
                        </a>
                    </motion.div>
                )}
