                        ...
                        <nav className="hidden md:flex justify-center items-center gap-8 flex-1">
                            {NAV_LINKS.map((link) => (
                                <button
                                    ...
                                    className={`relative text-xs hover:bg-transparent md:text-sm font-bold tracking-wide transition-colors duration-300 ${activeSection === link.id ? 'text-[#1D1D1F]' : 'text-gray-400 hover:text-[#1D1D1F]'
                                        }`}
                                >
                                    {link.label}
