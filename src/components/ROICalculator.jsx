...
const ROICalculator = () => {
 ...
 <span className="text-gray-400 font-bold block mb-3 text-sm">עלות תחזוקת מקרנים מיושנת</span>
 ...
 <span className="text-white font-bold block mb-4 text-lg">חיסכון משוער עם NextClass</span>
