...
const SmartSearchModal = ({ isOpen, onClose }) => {
 ...
 <span className="text-xs font-bold">{searchContent.popularLabel}</span>
 ...
 <div className="flex items-center gap-4 text-[10px] font-bold text-[#86868B]">
 ...
 <span className="text-[10px] font-black text-gray-400">spotlight search</span>
 </div>
 </motion.div>
 </div>
 )}
