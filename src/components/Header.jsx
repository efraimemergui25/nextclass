...
const Header = () => {
 ...
 <motion.span
  ...
  animate={{ scale: 1, opacity: 1 }}
  transition={{ type: 'spring', stiffness: 600, damping: 20 }}
  className="absolute top-1 right-1 bg-[#FF2D55] text-white text-[10px] font-bold w-4 h-4 md:w-5 md:h-5 rounded-full flex items-center justify-center shadow-sm pointer-events-none"
 >
  {wishlistCount}
 </motion.span>
 )}
