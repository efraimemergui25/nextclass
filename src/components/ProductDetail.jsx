        ...
        <div className="bg-white min-h-screen text-[#1D1D1F] font-sans antialiased">
            ...
            <section className="max-w-7xl mx-auto px-6 py-12 md:py-20 lg:px-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-base md:text-lg text-gray-600 leading-relaxed mb-10 space-y-4">
                            <p>
            ...
            <section className="bg-white py-16 border-t border-gray-100">
                <div className="max-w-4xl mx-auto px-6 lg:px-12">
                    <h2 className="text-2xl font-bold mb-8 tracking-tight">Technical Specifications</h2>

                    <div className="flex flex-col">
                        {/* Row 1 */}
                        <div className="flex flex-col sm:flex-row sm:items-center py-5 px-4 bg-[#FAFAFA] rounded-lg">
                            ...
                            <div className="sm:w-2/3 text-[#1D1D1F] font-medium pl-8 sm:pl-0 flex items-center">
                                ...
                                <div className="ml-3 relative group flex items-center cursor-help">
                                    ...
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 bg-[#1D1D1F] text-white text-xs leading-relaxed p-3 rounded-md opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity shadow-lg z-10 text-center">
                                        Supports up to 40 cores per processor for high-density computing.
                                        <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-1 border-4 border-transparent border-t-[#1D1D1F]"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Row 2 */}
                        <div className="flex flex-col sm:flex-row sm:items-center py-5 px-4 bg-white rounded-lg">
                            <div className="sm:w-1/3 flex items-center text-gray-500 font-medium mb-2 sm:mb-0">
                                <svg className="w-5 h-5 mr-3 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                            ...
                            <div className="sm:w-2/3 text-[#1D1D1F] font-medium pl-8 sm:pl-0">
            ...
            <section className="bg-[#F5F5F7] py-16">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <h2 className="text-2xl font-bold mb-10 tracking-tight text-center md:text-left">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        {/* Card 1 */}
                        <div className="flex-1 bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center border border-gray-100">
                            <div className="w-32 h-32 bg-[#F5F5F7] rounded-xl mb-6 flex items-center justify-center">
                                <svg className="w-12 h-12 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                                </svg>
                            </div>
                            <h3 className="text-lg font-semibold mb-2">64GB DDR4 ECC RAM</h3>
                            <p className="text-sm text-gray-500 mb-8">Certified expansion module.</p>
                            <button className="mt-auto w-full py-3 px-4 border-2 border-[#007AFF] text-[#007AFF] bg-transparent rounded-md font-medium text-sm hover:bg-blue-50 transition-colors focus:outline-none focus:ring-2 focus:ring-[#007AFF] focus:ring-offset-1">
                                Add Bundle
                            </button>
                        </div>
                        ...
                        <div className="flex-1 bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center border border-gray-100">
                            ...
                            <h3 className="text-lg font-semibold mb-2">3.84TB NVMe SSD</h3>
                            <p className="text-sm text-gray-500 mb-8">Enterprise mixed-use storage.</p>
                            <button className="mt-auto w-full py-3 px-4 border-2 border-[#007AFF] text-[#007AFF] bg-transparent rounded-md font-medium text-sm hover:bg-blue-50 transition-colors focus:outline-none focus:ring-2 focus:ring-[#007AFF] focus:ring-offset-1">
                                Add Bundle
                            </button>
                        </div>
                        ...
                        <div className="flex-1 bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow flex flex-col items-center text-center border border-gray-100">
                            ...
                            <h3 className="text-lg font-semibold mb-2">25GbE Network Card</h3>
                            <p className="text-sm text-gray-500 mb-8">Dual-port SFP28 adapter.</p>
                            <button className="mt-auto w-full py-3 px-4 border-2 border-[#007AFF] text-[#007AFF] bg-transparent rounded-md font-medium text-sm hover:bg-blue-50 transition-colors focus:outline-none focus:ring-2 focus:ring-[#007AFF] focus:ring-offset-1">
                                Add Bundle
                            </button>
                        </div>
