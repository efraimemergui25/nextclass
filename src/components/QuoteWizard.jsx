...
const BENEFITS = [
 ...
 { iconPath: "M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z", title: 'מחיר שקוף — ללא הפתעות', desc: 'הצעת מחיר = חשבונית. מה שהוצע הוא מה שמשלמים' },
];
...
const QuoteWizard = () => {
 ...
 <div className="text-[10px] font-black text-[#86868B] mb-3 text-right">מה כלול בחבילה:</div>
 ...
 <div className="text-[9px] font-black text-[#007AFF] mb-1">החל מ</div>
 ...
 <div className="bg-white rounded-xl p-3 border border-gray-100 text-center">
 <div className="text-[9px] font-black text-[#86868B] mb-1">זמן פריסה</div>
