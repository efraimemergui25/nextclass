...
const ExpertConsultation = () => {
 ...
 {/* Meeting type chips */}
 <div className="mb-10">
 <label className="text-xs font-bold text-gray-400 mb-4 block">איך תרצו להיפגש?</label>
 ...
 <div>
 <label className="text-xs font-bold text-gray-400 mb-4 block">תאריך מועדף</label>
 ...
 <div>
 <label className="text-xs font-bold text-gray-400 mb-4 block">שעה</label>
 <div className="relative rounded-2xl p-4 flex items-center justify-between cursor-pointer" style={glassField}>
 <div className="flex items-center gap-3 text-[#1D1D1F] font-bold text-lg">
